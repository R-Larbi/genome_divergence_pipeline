...
parser = argparse.ArgumentParser(description="Filters out isoforms in a protein FASTA file")
...
"""
Script to filter out isoforms in a protein FASTA file.
This is done so that BUSCO doesn't accidentally identify isoforms as multi-copy BUSCO genes.
"""
